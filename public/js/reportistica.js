...
function repPagRaggruppamenti(data, anno, mese, soloMese, nPag) {
  ...
  function simpleCard(d, color, title, desc, icon) {
    ...
    return '<div style="border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;background:white">'
      ...
      +'<div style="text-align:center;flex:1;padding:8px;background:#f8fafc;border-radius:8px;border:1px solid #e2e8f0"><div style="font-size:20px;font-weight:800;color:'+color+'">'+d.tot.toLocaleString('it-IT')+'</div><div style="font-size:9px;color:#64748b;font-weight:600">Totale</div></div>'
      +'<div style="text-align:center;flex:1;padding:8px;background:#fdf2f8;border-radius:8px;border:1px solid #fce7f3"><div style="font-size:20px;font-weight:800;color:#EC4899">'+d.donne.toLocaleString('it-IT')+'</div><div style="font-size:9px;color:#64748b;font-weight:600">Donne '+pD+'%</div></div>'
      +'<div style="text-align:center;flex:1;padding:8px;background:#ecfdf5;border-radius:8px;border:1px solid #d1fae5"><div style="font-size:20px;font-weight:800;color:#10B981">'+d.stranieri.toLocaleString('it-IT')+'</div><div style="font-size:9px;color:#64748b;font-weight:600">Stranieri '+pS+'%</div></div>'
      +'</div>'
  ...
  function giovaniCard(d) {
    ...
    return '<div style="border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;background:white">'
      ...
      +'<div style="display:flex;gap:8px;margin-bottom:10px">'
      +'<div style="text-align:center;flex:1;padding:8px;background:#fef2f2;border-radius:8px;border:1px solid #fecaca"><div style="font-size:20px;font-weight:800;color:#EF4444">'+d.tot.toLocaleString('it-IT')+'</div><div style="font-size:9px;color:#64748b;font-weight:600">Totale</div></div>'
      +'<div style="text-align:center;flex:1;padding:8px;background:#fdf2f8;border-radius:8px;border:1px solid #fce7f3"><div style="font-size:20px;font-weight:800;color:#EC4899">'+d.donne.toLocaleString('it-IT')+'</div><div style="font-size:9px;color:#64748b;font-weight:600">Donne '+pD+'%</div></div>'
      +'<div style="text-align:center;flex:1;padding:8px;background:#ecfdf5;border-radius:8px;border:1px solid #d1fae5"><div style="font-size:20px;font-weight:800;color:#10B981">'+d.stranieri.toLocaleString('it-IT')+'</div><div style="font-size:9px;color:#64748b;font-weight:600">Stranieri '+pS+'%</div></div>'
      +'</div>'
